...
import com.ido85.master.spider.untils;
...
//            String proxys = "";
//			try {
//				proxys = untils.lockNextHttpProxy();
...
//        	
//        	InetSocketAddress sa = new InetSocketAddress(HostArray[0], Integer.parseInt(HostArray[1]));
//        	proxy = new Proxy(Proxy.Type.HTTP, sa);
//        	Authenticator.setDefault(new MyAuthenticator("ninja67882", "OB0j8SIPlQolp"));
        }
    ...
    public static class Response extends HttpConnection.Base<Connection.Response> implements Connection.Response {
        ...
        private static HttpURLConnection createConnection(Connection.Request req) throws IOException {
        	...
        	Authenticator.setDefault(new MyAuthenticator("ninja67882", "OB0j8SIPlQolp"));
        	/*String proxyUser = "ninja67882";
        	String proxyPwd = "OB0j8SIPlQolp";
        	String headerKey = "Proxy-Authorization";  
        	String headerValue = "Basic " + Encodes.encodeBase64(proxyUser+":"+proxyPwd);  */
        	
        	HttpURLConnection conn;
        	
        	//System.out.println("=====================" + ((Request)req).getProxy() + "============" + req);
        	
        	if(((Request)req).getProxy() != null)
        		conn = (HttpURLConnection) req.url().openConnection(((Request)req).getProxy());
        	else 
