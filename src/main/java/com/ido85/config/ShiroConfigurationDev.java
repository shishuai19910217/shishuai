...
@Profile(value = "dev")
public class ShiroConfigurationDev {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		filters.put("statelessAuthc", new com.ido85.frame.web.rest.security.profile_dev.StatelessAuthcFilter());
		//互信机制
	    filters.put("trustStatelessAuthc", new com.ido85.frame.web.rest.security.profile_dev.TrustStatelessAuthcFilter());
