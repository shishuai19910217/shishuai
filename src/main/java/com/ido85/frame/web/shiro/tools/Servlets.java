...
public class Servlets {
	...
	// -- 常用数值定义 --//
		...
		// 静态文件后缀
		private final static String[] staticFiles = StringUtils.split(".css,.js,.png,.jpg,.gif,.jpeg,.bmp,.ico,.swf,.psd,.htc,.crx,.xpi,.exe,.ipa,.apk", ",");
		
		// 动态映射URL后缀
		private final static String urlSuffix = ".html";// Global.getUrlSuffix();
...
//				return (HttpServletRequest)WebUtils.getSavedRequest(null);
				return null;
			}
		}
