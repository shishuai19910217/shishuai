...
public class StatelessAuthcFilter extends AccessControlFilter {
	...
	protected boolean onAccessDenied(ServletRequest request,
		...
		System.out.println("--------prodmode:-----------"+accessKeyID+"------------url======"+((HttpServletRequest) request).getRequestURI()+"----sessionId===="+RestSessionUtil.getRestSessionId(accessKeyID));
