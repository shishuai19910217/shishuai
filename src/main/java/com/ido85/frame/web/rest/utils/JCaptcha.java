...
public class JCaptcha {
     ...
     *            图片高 
     */  
    public JCaptcha(int width, int height) {  
        this.width = width;  
        this.height = height;  
        this.createCode();  
    }  
     ...
     *            干扰线条数 
     */  
    public JCaptcha(int width, int height, int codeCount, int lineCount) {  
        this.width = width;  
        this.height = height;  
    ...
    public void createCode() {  
        ...
        //Graphics g = buffImg.getGraphics();//产生Image对象的Graphics对象,改对象可以在图像上进行各种绘制操作
    ...
    class ImgFontByte {  
        public Font getFont(int fontHeight) {  
            try {  
                ...
                Font baseFont = Font.createFont(Font.BOLD,  
