...
public class JavaSmsApi {
    ...
    public static void test_main(String[] args) throws IOException, URISyntaxException {

        //修改为您的apikey.apikey可在官网（http://www.yuanpian.com)登录后获取
        String apikey = "9dd84803f54ff467460e7c9ea31489f4";

        //修改为您要发送的手机号
        String mobile = URLEncoder.encode("18615597634",ENCODING);
...
//            + URLEncoder.encode("网链搜",ENCODING);
//        //模板发送的调用示例
